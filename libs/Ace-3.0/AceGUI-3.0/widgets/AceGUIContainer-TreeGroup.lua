...
local methods = {
	...
	["OnWidthSet"] = function(self, width)
		...
		---START CHANGES
		if (treeframe.SetMinResize) then --old versions of the game uses this method
			treeframe:SetMinResize(100, 1)
			treeframe:SetMaxResize(maxtreewidth, 1600)
		else
			treeframe:SetResizeBounds(100, 1, maxtreewidth, 1600) --new versions has this method
		end
		---END CHANGES
	end,
...
local function Constructor()
	...
	if (treeframe.SetMinResize) then --old versions of the game uses this method
		...
		treeframe:SetResizeBounds(100, 1, 400, 1600) --new versions has this method
	end
	---END CHANGES
