...
function HealBarsClassic:CreateConfigs()
			...
			textureGroup = {
				...
				args = {
					...
					cellTexture = {
						order = 150,
						type = 'select',
						name = 'Cell Heal Bar Texture',
						desc = 'Choose the texture for heal prediction bars on Cell frames.',
						values = {
							['Interface\\RaidFrame\\Raid-Bar-Hp-Fill'] = 'Raid Health Bar',
							['Interface\\TargetingFrame\\UI-StatusBar'] = 'Unit Frame Status Bar',
							['Interface\\RaidFrame\\Raid-Bar-Resource-Fill'] = 'Raid Resource Bar',
							['Interface\\RaidFrame\\Raid-Bar-Energy-Fill'] = 'Raid Energy Bar',
							['Interface\\RaidFrame\\Raid-Bar-Mana-Fill'] = 'Raid Mana Bar',
						},
						get = function() return HBCdb.global.cellTexture or 'Interface\\RaidFrame\\Raid-Bar-Hp-Fill' end,
						set = function(_,value) 
							HBCdb.global.cellTexture = value
							HealBarsClassic:UpdateCellTextures()
						end
					},
				}
			},
	...
	LibStub("AceConfigDialog-3.0"):AddToBlizOptions("HBCOptions","HealBarsClassic - Cell")
